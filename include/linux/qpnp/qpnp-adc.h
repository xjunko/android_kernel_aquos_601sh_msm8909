...
int sh_shbatt_smb1360_enable_fg_access(void);
int sh_shbatt_smb1360_disable_fg_access(void);
int sh_shbatt_smb1360_get_prp_current_now(void);
...
int sh_shbatt_smb1360_get_prp_voltage_ocv( void );
