...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 17-006 */
...
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 17-006 */
...
#ifndef CONFIG_SH_AUDIO_DRIVER /* 17-126 */
...
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 17-126 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 17-030 */
static int tombak_get_music_type_cb(struct notifier_block *nb, unsigned long event, void *data)
{
	int music_type = 0;
...
static struct notifier_block tombak_get_music_type_nb = {
	.notifier_call = tombak_get_music_type_cb,
};
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 17-030 */
				     ...
				     struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
#ifdef CONFIG_SHUB_ML630Q790
		dev_err(w->codec->dev, "%s Stop pedometer function\n", __func__);
...
#ifdef CONFIG_SHUB_ML630Q790
		dev_err(w->codec->dev, "%s Restart pedometer function\n", __func__);
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 17-006 */
	diag_codec_switch = msm8x16_wcd_priv;
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 17-006 */
#ifdef CONFIG_SH_AUDIO_DRIVER /* 17-030 */
	if (cpufreq_register_notifier(&tombak_get_music_type_nb, SH_CPUFREQ_ADJUST_NOTIFIER))
...
static int msm8x16_wcd_codec_remove(struct snd_soc_codec *codec)
{
	...
	atomic_set(&msm8x16_wcd_priv->on_demand_list[ON_DEMAND_MICBIAS].ref, 0);
#ifdef CONFIG_SH_AUDIO_DRIVER /* 17-030 */
	if (cpufreq_unregister_notifier(&tombak_get_music_type_nb, SH_CPUFREQ_ADJUST_NOTIFIER))
