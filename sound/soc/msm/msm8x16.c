...
static struct wcd_mbhc_config mbhc_cfg = {
	.read_fw_bin = false,
	.calibration = NULL,
#ifdef CONFIG_SH_AUDIO_DRIVER /* 17-064 */
	#if defined(CONFIG_MACH_LYNX_DF40) /* 17-124 */
...
#else
	.detect_extn_cable = false,
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 17-064 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 17-013 */
	S(v_hs_max, 1700);
#else
	S(v_hs_max, 1500);
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 17-013 */
#undef S
