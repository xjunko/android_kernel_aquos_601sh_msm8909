...
/*
 * /sys/devices/gpio_keys.73/camera
 */
static DEVICE_ATTR(camera, S_IWUSR | S_IRUGO,
...
#ifdef CONFIG_KEYBOARD_GPIO_CUST_SC
#ifndef CONFIG_MACH_PG24
		if (of_property_read_bool(pp, "sh_cust,senior")) {
			pdata->nbuttons--;
			continue;
		}
#endif /* CONFIG_MACH_PG20 */
#endif /* CONFIG_KEYBOARD_GPIO_CUST_SC */
