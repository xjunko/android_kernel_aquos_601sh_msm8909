...
/* SH_CAMERA_DRIVER-> */
#if defined(CONFIG_MACH_LYNX_DF40) || defined(CONFIG_MACH_NF1)
	F( 6015037,	gpll0,	1,	 1,	133),				// ((gpll0/a)*b)/c
	F( 8510638,	gpll0,	1,	 1,	94),				// ((gpll0/a)*b)/c
#elif defined(CONFIG_MACH_PG20) || defined(CONFIG_MACH_PG40)
	F( 6153846,	gpll0,	10,	 1,	13),				// ((gpll0/a)*b)/c
#elif defined(CONFIG_MACH_DECKARD_KF40)
	F( 6666666,	gpll0,	10,	 1,	12),				// ((gpll0/a)*b)/c
#endif	
/* SH_CAMERA_DRIVER<- */
