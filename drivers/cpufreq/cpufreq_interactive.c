...
#define DEFAULT_UP_THRESHOLD_FREQ_STEPHIGH					90
#define DEFAULT_UP_THRESHOLD_OVER_FREQ_STEPHIGH				90
#define DEFAULT_CPUFREQ_INTERACTIVE_THRESHOLD				800000
#define DEFAULT_CPUFREQ_INTERACTIVE_STEP					800000
#define DEFAULT_CPUFREQ_INTERACTIVE_STEPHIGH				1094400
#define DEFAULT_CPUFREQ_INTERACTIVE_SWITCH_STEP				1267200
...
#ifdef CONFIG_SHSYS_CUST
		if (pcpu->target_freq< tunables->interactive_switch_step_freq) {
			if (pcpu->target_freq < tunables->interactive_threshold) {
			...
			if (pcpu->target_freq < tunables->interactive_step_high_freq && new_freq > tunables->interactive_step_high_freq) {
				if (cpu_load > tunables->up_threshold_freq_step_high) {
					new_freq = tunables->interactive_step_high_freq;
				} else {
					new_freq = pcpu->target_freq;
				}
			} else if (pcpu->target_freq >= tunables->interactive_step_high_freq) {
					...
					struct cpufreq_policy *policy)
{
	...
	tunables->up_threshold_freq_step_high = DEFAULT_UP_THRESHOLD_FREQ_STEPHIGH;
	tunables->up_threshold_over_freq_step_high = DEFAULT_UP_THRESHOLD_OVER_FREQ_STEPHIGH;
