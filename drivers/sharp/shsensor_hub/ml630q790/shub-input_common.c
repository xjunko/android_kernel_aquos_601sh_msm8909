...
#define SHUB_GPIO_RST     (98)   /* 117->98 */
#define SHUB_GPIO_REMP    (49)   /* 118->49 */
#define SHUB_GPIO_INT0    (96)   /*  63->96 */
/* SHMDS_HUB_0115_01 mod S */
#ifdef SHUB_SW_GPIO_INT1
...
//     switch(gpio){
//     case SHUB_GPIO_PIN_RESET:
//         pin_config_set("1000000.pinctrl", "gp-98", config);
//         break;
//     case SHUB_GPIO_PIN_BRMP:
//         pin_config_set("1000000.pinctrl", "gp-49", config);
//         break;
//     case SHUB_GPIO_PIN_INT0:
//         pin_config_set("1000000.pinctrl", "gp-96", config);
//         break;
// #ifdef SHUB_SW_GPIO_INT1 /* SHMDS_HUB_0115_01 mod */
//     case SHUB_GPIO_PIN_INT1:
//         pin_config_set("1000000.pinctrl", "gp-76", config);
//         break;
// #endif
//     default:
//         break;
