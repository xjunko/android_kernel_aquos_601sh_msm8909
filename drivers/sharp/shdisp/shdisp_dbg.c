...
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE17         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     ...
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE18         (SHDISP_DBG_MODE_APPSBL_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE19         (SHDISP_DBG_MODE_APPSBL_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_DISPONCHK_STR  \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE20         (SHDISP_DBG_MODE_APPSBL_STR          \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_DISPONCHK_STR  \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE21         (SHDISP_DBG_MODE_APPSBL_STR          \
                                                     SHDISP_DBG_TYPE_BDIC_STR          \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_I2CREAD_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE22         (SHDISP_DBG_MODE_APPSBL_STR          \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSALSNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE23         (SHDISP_DBG_MODE_APPSBL_STR          \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_POWERNG_STR    \
                                                     "   0  \n")
...
static void shdisp_dbg_dispdump_generate(struct shdisp_dbg_zip_context* ctx, struct shdisp_dbg_dispdump_worker_params* params)
{
    ...
    if (params->ring_dump_buf.ptr != NULL) {
        ...
        if (params->mode == SHDISP_DBG_MODE_APPSBL) {
            errmsg = shdisp_dbg_dispdump_get_errmsg(SHDISP_DBG_INFO_APPSBL);
