...
#define SH_GPIO_CFG(n)    	(TLMM_BASE_ADDR + 0x0 + (0x1000) * n)
#define SH_GPIO_IN_OUT(n) 	(TLMM_BASE_ADDR + 0x4 + (0x1000) * n)
#define SH_GPIO_INTR_CFG(n) (TLMM_BASE_ADDR + 0x8 + (0x1000) * n)
